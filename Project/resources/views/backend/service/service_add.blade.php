        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <label for="service_name" class="form-label">Titre du produit fr</label>
                            <input type="text" name="service_name_fr" placeholder="Type here" class="form-control" id="service_name">
                        </div>
                        <div class="mb-4">
                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                        <div class="input-upload">
                            ...
                            <input name="service_thambnail" onChange="mainThamUrl(this)" class="form-control" type="file">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row gx-2">
                            ...
                            <div class="mb-4">
                                <label for="service_tags_fr" class="form-label">Tags fr</label>
                                <input name="service_tags_fr" type="text" class="form-control" value="Femmes,wigs,Accessoires">
                            </div>
                        </div> <!-- row.// -->
                    </div>
                </div> <!-- card end// -->
