...
$cpm_amount = intval($cartTotal); //TransactionAmount
...
<html>
<head>  
           <title>Cinetpay | Validation</title>  
...
<body>
    <form action="<?php echo $cpSecure; ?>" method="post">
        ...
        <div class="text-center"><br>
            <h1>Please Validate the transaction</h1><br>
            <p>Total Price : XAF <strong><?php echo intval($cartTotal) ; ?></strong></p>
        <input type="hidden" value="<?php echo $apikey; ?>" name="apikey">
        <p><input type="hidden" value="<?php echo intval($cartTotal) ; ?>" name="cpm_amount"></p>
        ...
        <br>
        <button type="submit" class="btn btn-primary"  id="bt_get_signature">Proceed to payment</button>	
